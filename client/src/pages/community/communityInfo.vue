			...
			<view class="example">
				...
				<uni-forms ref="baseForm" :model="baseFormData" labelWidth="80px">
					...
					<uni-forms-item label="社区名字" required>
						<uni-easyinput v-model="baseFormData.age" placeholder="请输入社区名字" />
					</uni-forms-item>
					<uni-forms-item label="联系方式" required>
						<uni-easyinput v-model="baseFormData.name" placeholder="请输入社区联系方式" />
					</uni-forms-item>
					<uni-forms-item label="省" required>
						<uni-easyinput v-model="baseFormData.name" placeholder="请输入社区所在省" />
					</uni-forms-item>
					<uni-forms-item label="市" required>
						<uni-easyinput v-model="baseFormData.name" placeholder="请输入社区所在市" />
					</uni-forms-item>
					<uni-forms-item label="详细地址" required>
						<uni-easyinput v-model="baseFormData.name" placeholder="请输入社区详细地址" />
					</uni-forms-item>
					<uni-forms-item label="成立日期" required>
						<uni-easyinput v-model="baseFormData.name" placeholder="请输入社区成立日期" />
					</uni-forms-item>
