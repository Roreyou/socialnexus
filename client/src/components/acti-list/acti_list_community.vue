    ...
    <view>
      <view class="cu-item" v-for="(item, index) in newAcList" :key="index">
        <view
          ...
          @click="todetail(item.id, 'recruiting')"
        >
          <view
            class="cu-item shadow"
            :class="{ indexstyle: isindex, others: !isindex }"
          >
            <!-- 活动状态 -->
            ...
            <view class="title"
              ><view :class="{ 'title-font': !ismyac, 'text-cut': ismyac }">{{
                item.name
              }}</view></view
            >
            <view class="conpic">
              <view class="content">
                <view class="desc">
                  ...
                  <view class="text-content">
                    省市: {{ item.province }} {{ item.city }}</view
                  >
                  <view class="text-content">
                    详细地址: {{ item.address }}</view
                  >

                  <view v-if="ismyac" class="text-content">
                    录取状态: {{ item.admission_status }}</view
                  >
