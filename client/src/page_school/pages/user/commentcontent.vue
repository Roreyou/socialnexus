...
<template>
    <view>
		...
		<u-empty v-if="com_list.length == 0" text="暂无内容" mode="history" margin-top="30rpx" font-size="35"></u-empty>
...
import commentlist from '../../../page_school/components/comment-list/comment-list.vue';
export default {
    components: {
        commentlist
    },
